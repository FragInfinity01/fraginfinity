      ...
      <div className="team-cards">
        <div className="player-card">
          ...
          <div className="player-description">
            ...
            <p className="desc">
              Kernel 32 is a dynamic esports player known for his prowess in
              Valorant, Farlight 84, Rocket League, and Brawlhalla, consistently
              delivering standout performances and strategic brilliance. He is
              also the founder of FragInfinity, where his leadership and passion
              for gaming continue to inspire and drive the esports community
              forward.
            </p>
        ...
        <div className="player-card">
          ...
          <div className="player-description">
            ...
            <p className="desc">
              Coolgyal is an exceptional esports player excelling in Valorant,
              Farlight 84 and Brawlhalla, known for her strategic gameplay and
              impressive skills. As the founder of FragInfinity, she not only
              showcases her talent across multiple games but also leads and
              inspires the esports community through her innovative vision and
              dedication.
            </p>
            <div className="social-links">
              <a href="https://www.twitch.tv/fraginfinityza" target="_blank">
        ...
        <div className="player-card">
          ...
          <div className="player-description">
            ...
            <p className="desc">
              Meet REVENVNT, a passionate gamer who dives into Valorant,
              Farlight 84, Rocket League, and Brawlhalla with a competitive
              spirit. Known also as the founder of FragInfinity, he&#39;s built
              a community around his love for gaming, fostering camaraderie and
              skill development among players. Whether strategizing in tactical
        ...
        <div className="player-card">
          ...
          <div className="player-description">
            ...
            <p className="desc">
              A versatile gamer who thrives in Valorant, Farlight 84, Rocket
              League, and Brawlhalla. With a knack for competitive gaming,
              BlackNoise navigates each title with skill and enthusiasm,
              bringing a strategic edge to the virtual battlefield. Whether
              honing precise aim in FPS matches or mastering the art of teamwork
              in fast-paced sports games.
            </p>
            <div className="social-links">
              <a href="https://www.twitch.tv/blacknoisettv" target="_blank">
                <img src={Twitch} alt="twitch logo" />
              </a>
              <a href="https://discord.gg/C3kwUSJ4j7" target="_blank">
                <img src={Discord} alt="discord logo" />
              </a>
              <a href="https://www.instagram.com/steve_art16/" target="_blank">
                <img src={Instagram} alt="instagram logo" />
              </a>
              {/* <a href="https://www.instagram.com/steve_art16/" target="_blank"><img src={TikTok} alt="tiktok logo" /></a> */}
              <a href="http://www.youtube.com/@stevemolele6902" target="_blank">
                <img src={YouTube} alt="youtube logo" />
              </a>
            </div>
          </div>
